...
create_signup_window (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed30), signup_button, 16, 616);
  ...
  gtk_fixed_put (GTK_FIXED (fixed30), signup_go_signin_button, 360, 616);
  gtk_widget_set_size_request (signup_go_signin_button, 74, 29);
  ...
  g_signal_connect ((gpointer) signup_go_signin_button, "clicked",
                    G_CALLBACK (signup_go_signin_button),
                    NULL);
...
create_signin_window (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (signin_grid), signin_button, 136, 416);
  ...
  gtk_fixed_put (GTK_FIXED (signin_grid), signin_go_signup_button, 360, 416);
  gtk_widget_set_size_request (signin_go_signup_button, 90, 29);
